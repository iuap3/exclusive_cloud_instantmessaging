...
## 1.3下载小友SDK
小友移动端iOS SDK下载地址:
[下载中心](https://iuap.yonyoucloud.com/doc/instantmessaging.html#/md-build/exclusive_cloud_instantmessaging/articles/product/11-/download.md?key=相关下载)<br/>
SDK结构目录如下图所示:
![noim.png](http://iuapcdn.yonyoucloud.com/md-build/exclusive_cloud_instantmessaging/articles/product/6-/xiaoyou/ios/noim.png)
## 1.4申请百度语音服务账号
